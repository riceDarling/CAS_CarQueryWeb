...
},beforePageText:"第",afterPageText:"页，共 {pages} 页",displayMsg:"显示 {from} 到 {to} ，总共 {total} 项",nav:{first:{iconCls:"pagination-first",handler:function(){
...
r=_6bb(eval("r1['"+sn.replace(/\./g,"']['")+"']"),eval("r2['"+sn.replace(/\./g,"']['")+"']"))*(so=="asc"?1:-1);
if(r!=0){
return r;
}
}
