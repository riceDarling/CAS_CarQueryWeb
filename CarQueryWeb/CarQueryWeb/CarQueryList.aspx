<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CarQueryList.aspx.cs" Inherits="CarQueryWeb.CarQueryList" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function loadTable() {
            ...
            $('#tabmenu').bootstrapTable({
                url: './CarQueryIndex.aspx/GetCheckList',
                method: 'post',      //请求方式（*）
                ...
                pageSize: 15,      //每页的记录行数（*）
                pageList: [10, 15, 25, 45, 50],  //可供选择的每页的行数（*）
                singleSelect: false,
                pagination: true,
                ...
                }, onLoadError: function (static, res) {
                    //debugger;
                    //alert("error");
                    //alert(res);
                },
                    ...
                    <div style="margin: 0 auto;" class="col-md-12 col-sm-12">
                        <table class="query-table">
                            <tr>
                                ...
                                <td class="field">车辆类型:&nbsp;&nbsp;</td>
                                <td class="content">
                                    <select id="VehicleModel" class="selectbox">
                                        <option value="-1">全部</option>
                                        <%
                                            System.Data.DataTable VehicleModelDataTable = CarQueryWeb.Common.CommonUtil.GetSelectDataTable("14");
                                            if (VehicleModelDataTable != null)
                                            {
                                                for (int i = 0; i < VehicleModelDataTable.Rows.Count; i++)
                                                {
                                                    System.Data.DataRow VehicleModeldr = VehicleModelDataTable.Rows[i];
                                        %>
                                        <option value="<%=VehicleModeldr["DID"] %>"><%=VehicleModeldr["DNAME"] %></option>
                                        <%
                                                }
                                            }
                                        %>
                            ...
                            <tr>
                                ...
                                <td class="field">检测结果:&nbsp;&nbsp;</td>
                                <td class="content">
                                    <select id="CheckResult" class="selectbox">
                                        <option value="-1">全部</option>
